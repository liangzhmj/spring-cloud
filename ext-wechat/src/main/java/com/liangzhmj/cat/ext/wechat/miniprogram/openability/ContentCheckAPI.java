...
public class ContentCheckAPI {
     ...
     * @return errcode:0 正常
     */
    public static JSONObject imgSecCheck(String appid,File data){
        ...
        return APIUtils.callAPI(url,appid,header,data);
    }
     ...
     * @return errcode:0 正常
     */
    public static JSONObject mediaCheckAsync(String appid,String mediaUrl,int type){
        ...
        return APIUtils.callAPI(url,appid,params);
    }
    /**
     * 检查一段文本是否含有违法违规内容。
     * 应用场景举例：
     ...
     * @return errcode:0 正常
     */
    public static JSONObject msgSecCheck(String appid,String content){
