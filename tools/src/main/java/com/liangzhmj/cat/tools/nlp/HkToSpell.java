 ...
 */
@Log4j2
public class HkToSpell {

    //有声调
    @Getter
    public Map<String, List<String>> cache = new HashMap<>();
    public static HkToSpell my;
     ...
     * @return
     */
    public static HkToSpell getInstance(){
        if(my != null){
            return my;
        }
        synchronized (HkToSpell.class){
            if(my != null){
                return my;
            }
            my = new HkToSpell();
    ...
    public static List<String> getPinyin(char word){
        return HkToSpell.getPinyin(String.valueOf(word));
    }
    ...
    public static List<String> getPinyin(String word){
        return HkToSpell.getInstance().getCache().get(word);
    }
    ...
    public static String getStrPinyin(String str,String blank){
        ...
        for (int i = 0; i < str.length(); i++) {
            List<String> pys = HkToSpell.getPinyin(str.charAt(i));
